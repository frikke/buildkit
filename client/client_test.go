...
func TestIntegration(t *testing.T) {
	testIntegration(
		...
		testExportLocalNoSplit,
		testExportLocalNoSplitOverwrite,
	)
}
...
func testExportLocalNoSplit(t *testing.T, sb integration.Sandbox) {
...
func testExportLocalNoSplitOverwrite(t *testing.T, sb integration.Sandbox) {
	integration.CheckFeatureCompat(t, sb, integration.FeatureOCIExporter, integration.FeatureMultiPlatform)
	c, err := New(sb.Context(), sb.Address())
	require.NoError(t, err)
	defer c.Close()
